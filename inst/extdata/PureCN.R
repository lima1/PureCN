...
option_list <- list(
    ...
    make_option(c("--rds"), action="store", type="character", default=NULL,
        help="PureCN output RDS file, used to regenerate plots and files after manual curation"),
    make_option(c("--genome"), action="store", type="character", default=NULL,
        help="Genome version [default %default]"),
    ...
    make_option(c("--snpblacklist"), action="store", type="character", default=NULL,
        help="File parsable by rtracklayer that defines blacklisted SNP regions"),
    make_option(c("--normal_panel"), action="store", type="character", default=NULL,
        help="VCF containing calls from a panel of normals, for example generated by GATK CombineVariants."),
    make_option(c("--statsfile"), action="store", type="character", default=NULL,
        help="MuTect stats file, used to filter artifacts"),
    make_option(c("--targetweightfile"), action="store", type="character", default=NULL,
        help="Weights of targets in segmentation. Generated by NormalDB.R."),
    make_option(c("--funsegmentation"), action="store", type="character", default="CBS",
        help="Segmentation function. CBS, PSCBS or none [default %default]"),
    make_option(c("--alpha"), action="store", type="double", 
        default=formals(PureCN::segmentationCBS)$alpha,
        help="Segmentation parameter, significance of breakpoints [default %default]"),
    make_option(c("--normaldb"), action="store", type="character", default=NULL,
        help="NormalDB.rds file. Generated by NormalDB.R."),
    ...
    make_option(c("--outvcf"), action="store_true", default=FALSE,
        help="Annotate input VCF with posterior probabilities. Otherwise produce CSV file."),
    make_option(c("--out"), action="store", type="character", default=NULL,
        help=paste("File name prefix to which results should be written.",
...
.getFilePrefix <- function(out, sampleid) {
    if (file.info(out)$isdir) return(file.path(out, sampleid))
    out
}
