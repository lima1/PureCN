...
# install GATK4
RUN wget --no-verbose https://github.com/broadinstitute/gatk/releases/download/4.2.4.0/gatk-4.2.4.0.zip && \
    unzip gatk-4.2.4.0.zip -d /opt && \
    rm gatk-4.2.4.0.zip

ENV PATH /opt/gatk-4.2.4.0:$PATH
