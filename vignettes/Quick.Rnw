...
The \Rcode{--offtarget} flag will include off-target reads. For Amplicon data
of if your assay contains dense tiling probes, you should exclude them. 
...
\item Providing the normal database in addition to a matched normals is
